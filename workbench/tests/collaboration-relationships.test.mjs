...
import {Collaboration,differenceMarkup,differenceLabel} from '../frontend/components/collaboration.js';
import {relationshipValueMarkup,relationshipEditor,collectRelationshipValue,relationshipOptions} from '../frontend/components/collaboration.js';
