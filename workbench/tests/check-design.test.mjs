...
import {emptyDesign,designMarkup,designNode,ruleValue,bindDesign} from '../frontend/components/check-design.js';
...
test('changing the value type clears obsolete validation errors on the value control',()=>{
 ...
 const error={},preview={},host={querySelectorAll:s=>s==='[data-rd]'?[]:controls,querySelector:s=>s==='.rd-error'?error:preview};
