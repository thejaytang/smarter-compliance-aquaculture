...
from system2.support.paths import PROJECT_ROOT, LEGACY_ROOT


ROOT = PROJECT_ROOT
ROUND1 = LEGACY_ROOT / "outputs" / "runs" / "goal04-round1"
ROUND3_FARM = (
    LEGACY_ROOT / "outputs" / "runs" / "goal04-round3"
    / "farm-standard-p064-p065-active" / "raw"
)
ROUND4_SALMON = (
    LEGACY_ROOT / "outputs" / "runs" / "goal04-round4"
    / "salmon-cod-standard-p027-p028-active" / "raw"
)
ROUND5_AUDIT = (
    LEGACY_ROOT / "outputs" / "runs" / "goal04-round5"
