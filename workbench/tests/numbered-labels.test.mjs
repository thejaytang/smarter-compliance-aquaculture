import {MarkdownNotebook} from '../frontend/components/markdown-content.js';
import test from 'node:test';
import assert from 'node:assert/strict';
import {numberedText,orderMarkup,orderEditorMarkup,relationshipValueMarkup,relationshipEditor,differenceLabel} from '../frontend/components/collaboration.js';
