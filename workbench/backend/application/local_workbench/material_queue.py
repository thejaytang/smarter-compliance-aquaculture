...
class MaterialQueue:
    ...
    def listing(self, actor, bucket, offset=0, limit=50, query='', task_type=''):
        from local_workbench.collaboration import named, fingerprint
        actor = named(actor)
    ...
    def create(self, actor, request):
        from local_workbench.collaboration import named, now, fingerprint
    ...
    def save(self, actor, request):
        from local_workbench.collaboration import named, now, fingerprint, COORDINATOR
