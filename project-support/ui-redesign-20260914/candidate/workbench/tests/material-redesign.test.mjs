...
function workspace(){
 ...
 w.root={querySelectorAll:()=>[]};w.q=s=>nodes.get(s)||null;w.state={actor:{id:'a'}};w.material={id:'m',revision:4,source:{source_id:'s'},collaboration:{view:'personal'}};w.id='m';w.draft={blocks:[{text:'unsaved original text'}]};w.dirty=true;w.message=()=>{};
