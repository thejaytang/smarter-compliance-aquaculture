...
4. Double-click Open Reviewer Workbench.cmd. It creates a separate
   reviewer-workspace data folder beside the code. To choose another local folder:
   "Open Reviewer Workbench.cmd" --root "C:\\review-data\\reviewer-workbench"
...
def main():
    ...
    for relative in ('system3/DESIGN.md','system3/docs/design-basis.md', 'docs/design/offline-human-review.md', 'docs/design/human-led-workbench-goal.md', 'system2/docs/contracts/human-material-workbench.md'):
