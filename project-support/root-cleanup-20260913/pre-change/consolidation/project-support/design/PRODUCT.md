...
These facts and constraints come from the user's activated [product-readiness goal](../../docs/design/human-led-workbench-goal.md#active-goal-extension-product-readiness-2026-09-12); this is the design skill's concise product context, not another implementation-status source.
...
- Pending materials and Archive organize current work and accepted historical content.
- Original, editable source content and future structured Requirements occupy three adjustable panes.
