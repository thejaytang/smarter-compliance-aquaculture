...
The approved [offline human review extension](project-support/design/offline-human-review.md) governs personal drafts, manual package exchange, conflict decisions and explicit main adoption. Reviewer workspaces must not run coordinator business schedules. Actual Windows round-trip evidence is required before reporting this extension complete.
