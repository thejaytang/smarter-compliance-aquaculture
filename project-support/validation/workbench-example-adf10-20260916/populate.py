...
cond=paragraph[:paragraph.index(', skal')]
specs=[
 dict(key='R1',ids=[0],fields={'Subject':'driftsjournalen','Modal Verb':'skal','Main Verb':'inneholde','Object':'oppdaterte opplysninger'},conditions=[cond]),
 dict(key='R2',ids=[0,1],fields={'Subject':'driftsjournalen','Modal Verb':'skal','Main Verb':'inneholde','Object':'akvakulturdyr og akvakulturdyrprodukter tatt inn til og ut fra akvakulturanlegget'},conditions=[cond],details=['opprinnelsessted','mottakssted']),
 dict(key='R3',ids=[0,2],fields={'Subject':'driftsjournalen','Modal Verb':'skal','Main Verb':'inneholde','Object':'dødelighet per produksjonsenhet'},conditions=[cond,'som er relevant for produksjonsformen']),
 dict(key='R4',ids=[0,3],fields={'Subject':'driftsjournalen','Modal Verb':'skal','Main Verb':'inneholde','Object':'resultater av gjennomførte helsekontroller'},conditions=[cond],details=['antall gjennomførte helsekontroller','prøveuttak','foretatte undersøkelser','diagnoser','gjennomførte behandlinger'])]
units={}
for spec in specs:
