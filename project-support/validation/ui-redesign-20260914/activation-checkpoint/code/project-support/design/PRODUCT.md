...
- Original, editable source content and future structured Requirements always occupy three side-by-side adjustable panes, including narrow/zoomed views with accessible overflow.
- One compact global navigation row and one record task bar lead full-space lists/details. No permanent global rail, material register, action-history module or mandatory Overview.
