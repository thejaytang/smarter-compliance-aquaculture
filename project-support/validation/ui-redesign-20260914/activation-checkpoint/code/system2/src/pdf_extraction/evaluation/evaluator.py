...
def evaluate_manifest(manifest_path: str | Path, output_path: str | Path) -> dict[str, Any]:
    ...
    report = {
        ...
        "evaluation_scope": "legacy_feature_regression",
        "independent_source_accuracy": "not_assessed",
        "metric_limitations": [
            "Header and footer text is excluded by this legacy feature projection.",
            "Cell text/span scores are unpositioned collections and cannot establish row/column correctness.",
            "Cross-page metrics compare counts, not the identity or meaning of links.",
            "This manifest does not authenticate independent human references or held-out qualification.",
        ],
