...
The user authorized the [2026-09-14 UI and interaction redesign](project-support/design/workbench-ui-redesign-goal-20260914.md). It owns the new two-workspace/six-module information architecture, one-row navigation, always-side-by-side resizable material panes and shared review/archive interface. It supersedes conflicting earlier layout, responsive pane-tab and completed-closeout stop rules for this new scope only. Preserve human decision, original/history, confidentiality and external-action boundaries. A recorded goal is not evidence of implementation or runtime activation.
