...
Status: implemented bounded local mechanism; not independently calibrated source acceptance. The [aligned target](../../../project-support/design/requirement-workstream-target.md) owns the broader verifier requirement. [Checkpoint evidence](../reports/32-original-page-verifier.md) identifies the tested scope.
