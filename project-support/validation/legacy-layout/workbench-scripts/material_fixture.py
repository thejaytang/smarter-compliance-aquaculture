...
def build(extra_specimens=()):
    ...
    config = json.loads((ROOT / 'workbench/backend/system1/Code/config/config.json').read_text())
    ...
    source_db = ROOT / 'workbench/backend/system1/Code/runtime/governance.sqlite'
