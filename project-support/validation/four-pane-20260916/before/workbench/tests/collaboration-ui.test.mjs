...
import {Collaboration,pointerParts,differenceBlock,differenceLabel,differenceMarkup,provenanceMarkup,valueEditor,collectEditedValue,importResultMessage} from '../ui/collaboration.js';
