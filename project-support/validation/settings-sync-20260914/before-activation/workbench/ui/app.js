...
async function refresh(render=true){
  ...
  $('#operator-name').textContent=state.actor.name||'Select reviewer';
  $('#operator-menu-label').title=state.actor.name ? state.actor.name+' · Reviewer and settings' : 'Select reviewer';
