...
def main(argv: list[str] | None = None) -> int:
    ...
    print(json.dumps({"report": str(args.output), "scope": report["evaluation_scope"],
        "independent_source_accuracy": report["independent_source_accuracy"],
        "aggregate": report["aggregate"], "failures": failures}, indent=2))
