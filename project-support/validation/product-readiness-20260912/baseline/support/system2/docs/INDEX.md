...
Current integration: [two-stage workflow](contracts/two-stage-review.md), [optional assistance/calibration](contracts/optional-assistance.md), [implementation evidence](reports/15-two-stage-workflow.md).
...
- [Original-page comparison](contracts/original-verification.md): standalone checker, guarded page checks, evidence and human repair.

## Acceptance records

- [Original-page verifier checkpoint](reports/32-original-page-verifier.md): real isolated loop, preserved source/history, failure/recovery and unresolved acceptance.
