...
VERSION = 'material-structural-parser/6'
POLICY = {'adapter': VERSION, 'semantic_processing': False, 'external_models': False, 'ocr': False, 'pdf_window_pages': 3, 'pdf_backend': 'pdfium', 'pdf_marker_order': 'same-row-before-body/1', 'pdf_paragraph_grouping': 'same-page-source-preserving/1', 'table_grid_guard': 'native-line-grid-consistency/1', 'table_grid_tolerance_points': 1.0, 'table_grid_reject_ratio': 0.25, 'human_adoption_required': True}
