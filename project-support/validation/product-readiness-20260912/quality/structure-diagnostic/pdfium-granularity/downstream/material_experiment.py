...
VERSION = 'material-structural-parser/4+dev-pdfium-granularity'
POLICY = {'adapter': VERSION, 'semantic_processing': False, 'external_models': False, 'ocr': False, 'pdf_window_pages': 3, 'pdf_backend': 'pdfium', 'native_granularity': 'pdfium-character-word-evidence/experiment-1', 'pdf_marker_order': 'same-row-before-body/1', 'pdf_paragraph_grouping': 'same-page-source-preserving/1', 'human_adoption_required': True}
...
def _pdf_blocks(raw, source, output, page_indices):
    from rich_native import RichNativeExtractor as NativeExtractor
