...
assert hashfile(SYSTEM/'src/pdf_extraction/orchestration/material_parser.py') == 'ae3745c920366edfb70934e540f2fbe745835ff772a16aa540b751713123388e', 'Parser drift before run'
...
after=fingerprint();save('code-after.json',after);gold_after={str(p.relative_to(SYSTEM)):hashfile(p) for p in (SYSTEM/'gold').rglob('*') if p.is_file()}
