...
requires a named-human decision before it can affect the source register.
``Human Operation Desktop`` retains hidden adapter staging; connected operator
actions use the browser workbench.
"""
